...
genai.configure(api_key="AIzaSyAyN9cloankoPG3T9zCqT5ExVleXZJKocg")  
...
tts.setProperty('voice', voices[4].id)  # Use a specific voice
...
def get_user_prompt_by_voice():
    ...
    with sr.Microphone() as source:
        ...
        speak("Ask your question about the item.")
...
def run_farmers_market_assistant(product_name, price):
    ...
    while True:
        ...
        if any(exit_phrase in user_question for exit_phrase in ["thank you", "thanks", "goodbye", "i'm done", "stop", "quit", "exit", "no more questions"]):
